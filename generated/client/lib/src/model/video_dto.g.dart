...
class _$VideoDto extends VideoDto {
  ...
  _$VideoDto._(
    ...
    BuiltValueNullFieldError.checkNotNull(length, r'VideoDto', 'length');
    BuiltValueNullFieldError.checkNotNull(coverUrl, r'VideoDto', 'coverUrl');
      ...
      _$result = _$v ??
          new _$VideoDto._(
              ...
              length: BuiltValueNullFieldError.checkNotNull(
                  length, r'VideoDto', 'length'),
              coverUrl: BuiltValueNullFieldError.checkNotNull(
                  coverUrl, r'VideoDto', 'coverUrl'),
              maker: maker,
              label: label,
              tags: tags.build(),
