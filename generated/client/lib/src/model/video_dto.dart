...
abstract class VideoDto implements Built<VideoDto, VideoDtoBuilder> {
  ...
  @BuiltValueField(wireName: r'sampleUrls')
  BuiltList<String> get sampleUrls;
...
class _$VideoDtoSerializer implements PrimitiveSerializer<VideoDto> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield r'length';
    yield object.length == null ? null : serializers.serialize(
      object.length,
    ...
    yield r'maker';
    yield object.maker == null ? null : serializers.serialize(
      object.maker,
      specifiedType: const FullType.nullable(String),
    );
    yield r'label';
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'sampleUrls':
          ...
          result.sampleUrls.replace(valueDes);
          break;
        case r'maker':
          final valueDes = serializers.deserialize(
            value,
